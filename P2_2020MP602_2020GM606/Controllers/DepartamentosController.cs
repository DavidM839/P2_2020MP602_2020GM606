...
namespace P2_2020MP602_2020GM606.Controllers
{
    public class DepartamentosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id_departamento,Nombre_dep")] Departamento departamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id_departamento,Nombre_dep")] Departamento departamento)
        {
